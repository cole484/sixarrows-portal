...
const PROJECTS = {
  ...
  testclient: {
    ...
    teamEmail: 'cole@sixarrowsconstruction.com',
    quickSummary: 'Mock construction client for portal testing.',
  ...
  // ── Fox Demo (fresh-start test client for Selections v2) ─────────────────────
  foxdemo: {
    id: 'foxdemo',
    email: 'fox@demo.com',
    password: 'fox2026',
    clientName: 'Fox Demo',
    projectName: 'Fox Walkthrough Home',
    location: 'Bowling Green, KY',
    status: 'Active Construction',
    statusType: 'construction',
    projectType: 'new_build',
    ...
    teamPhone: '(270) 782-5388',
    teamEmail: 'cole@sixarrowsconstruction.com',
    quickSummary: 'Fresh sandbox for Fox (Selections v2) end-to-end testing.',
    badges: JSON.parse(JSON.stringify(DEFAULT_BADGES)),
    selectionsClientKey: 'foxdemo',
    notionTrackerPageId: null,
    notionTimelineDbId: null,
  ...
  test_client_sab: {
    ...
    selectionsClientKey: 'test_client_sab',
    notionTrackerPageId: '3324737b-ea6f-81d3-9c4f-d5fa8aebdeea',
    notionTimelineDbId:  '',
    links: { budget: '#', timeline: '#' },
    decisions: [],
  ...
  lindsey: {
    id: 'lindsey',
    email: 'lindsey@client.com',
    password: 'lindsey2026',
    clientName: 'Lex & Joanna Lindsey',
    ...
    constructionPct: 0,
    sabProgress: 0,
    phaseLabel: 'Phase 2 — Design & Scope Lock',
    groundbreakingDate: '',
    budgetTotal: 0, budgetCommitted: 0, budgetAllowance: 0, budgetContingency: 0,
    changeOrders: 0, changeOrderItems: [],
    timelineStart: 'TBD', timelineTarget: 'TBD',
    teamLead: 'Cole Borders', teamPhone: '(270) 782-5388', teamEmail: 'cole@sixarrowsconstruction.com',
    quickSummary: 'Welcome to your Six Arrows client portal.',
    badges: JSON.parse(JSON.stringify(DEFAULT_BADGES)),
    selectionsClientKey: 'lindsey',
    notionTrackerPageId: '2fb4737b-ea6f-8062-bed1-ca0aa0760890',
    links: { budget: '#', timeline: '#' },
    decisions: [], updates: [], timeline: [], documents: [], budgetCategories: [],
    sabPhases: JSON.parse(JSON.stringify(DEFAULT_SAB_PHASES)),
  },
  ...
  wilkins: {
    id: 'wilkins',
    email: 'wilkins@client.com',
    password: 'wilkins2026',
    clientName: 'Wilkins Family',
    projectName: 'Home Remodel',
    location: 'Bowling Green, KY',
    status: 'In SAB™ Process',
    statusType: 'sab',
    ...
    quickSummary: 'Welcome to your Six Arrows client portal.',
    badges: JSON.parse(JSON.stringify(DEFAULT_BADGES)),
    selectionsClientKey: 'wilkins',
    notionTrackerPageId: '2fb4737b-ea6f-8098-a309-c6b8e57d37cb',
    links: { budget: '#', timeline: '#' },
    decisions: [], updates: [], timeline: [], documents: [], budgetCategories: [],
    sabPhases: JSON.parse(JSON.stringify(DEFAULT_SAB_PHASES)),
  },
  ...
  kerr: {
    id: 'kerr',
    email: 'kerr@client.com',
    password: 'kerr2026',
    clientName: 'Kerr Family',
    projectName: 'Home Remodel & Addition',
    location: 'Bowling Green, KY',
    status: 'In SAB™ Process',
    statusType: 'sab',
    projectType: 'remodel',
    ...
    quickSummary: 'Welcome to your Six Arrows client portal.',
    badges: JSON.parse(JSON.stringify(DEFAULT_BADGES)),
    selectionsClientKey: 'kerr',
    notionTrackerPageId: '2e84737b-ea6f-803c-af9c-c1d59ec3cc46',
    links: { budget: '#', timeline: '#' },
    decisions: [], updates: [], timeline: [], documents: [], budgetCategories: [],
    sabPhases: JSON.parse(JSON.stringify(DEFAULT_SAB_PHASES)),
  },
...
const AUTH = {
  ...
  _normalize(d) {
    return {
      ...
      photoFolders:         Array.isArray(d.photo_folders) ? d.photo_folders : [],
      ...
      teamLead:             d.team_lead  || d.cx_name  || 'Cole Borders',
      teamPhone:            d.team_phone || d.cx_phone || '(270) 782-5388',
      teamEmail:            d.team_email || d.cx_email || 'cole@sixarrowsconstruction.com',
      cxName:               d.cx_name    || d.team_lead  || 'Cole Borders',
      cxPhone:              d.cx_phone   || d.team_phone || '(270) 782-5388',
      cxEmail:              d.cx_email   || d.team_email || 'cole@sixarrowsconstruction.com',
      pmName:               d.pm_name    || '',
      pmPhone:              d.pm_phone   || '',
      pmEmail:              d.pm_email   || '',
      groundbreakingDate:   d.groundbreaking_date || '',
